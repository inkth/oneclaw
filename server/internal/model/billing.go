...
// 不阻断出片。含 ≈42 条 8s 出片(12000/280)。
// 基线必须跟着月费走:TEAM 不限量且超基线不阻断,月费是唯一的成本保底 —— 基线跑满的
// 视频成本(12000×¥0.0249≈¥299)必须低于月费(¥399),否则中度用户段会倒挂。
// 按 ¥399/12000 = ¥0.0333/积分标定,与 PRO 同价;TEAM 卖的是超出不断供 + 按量结算。
const TeamBaselineCredits = 12000
